...
def choose_path():
    while True:
        try:
            ...
            if choice == 1:
                project_path = "/Users/macbook_air/Desktop/backup/MyProject/Appium"
                report_path = os.path.join(project_path,
                                           f"/Users/macbook_air/Desktop/backup/MyProject/Appium/report/{formatted_date}/")
                case_path = os.path.join(project_path, "test_cases")
                return project_path, report_path, case_path
            elif choice == 2:
                project_path = "/Volumes/Disk/MyProject/Appium"
                report_path = os.path.join(project_path,
                                           f"/Volumes/Disk/MyProject/Appium/report/{formatted_date}/")
                case_path = os.path.join(project_path, "test_cases")
                return project_path, report_path, case_path
            else:
