...
project_path = "/Users/macbook_air/Desktop/MyProject/Zhujia_Factory"
report_path = os.path.join(project_path,
                           f"/Users/macbook_air/Desktop/MyProject/Zhujia_Factory/report/{month_formatted_date}/{formatted_date}/")
