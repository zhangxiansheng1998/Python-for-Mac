...
shop_list = {
    ...
    # 今日营业额
    'today_income_text': (By.XPATH,'//*[@id="main"]/div[2]/div[3]/div/div/header/span'),
    # 今日营业额-店铺今日统计
    'today_income_close': (By.XPATH, '/html/body/div[1]/div/div[2]/div[2]/div[2]/div[3]/div/div/header/button'),
    # 今日营业额-关闭按钮
