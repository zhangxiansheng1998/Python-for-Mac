...
class GoodsManagement(BasePage):
    ...
    def search_goods(self):
        ...
        self.wait(2)
        self.assert_text_euqal('测试上传视频后，编辑时能否看到视频', goods_list['goods_text'])
    ...
    def shelf_goods(self):
        ...
        self.wait(3)
        self.assert_text_euqal('下架成功', goods_list['assert_box'])
        self.click(goods_list['off_sale'])
        self.wait(1)
        self.click(goods_list['select_goods'])
        self.click(goods_list['multiple_times_shelf'])
        self.wait(3)
        self.assert_text_euqal('上架成功', goods_list['assert_box'])
    ...
    def add_goods(self):
        ...
        self.wait(2)
        self.assert_text_euqal('操作成功！', add_goods['assert_box'])
